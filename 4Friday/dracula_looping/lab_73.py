...
'''
StephanieCobble | Lab 73 - Challenge - Simplifying Code
'''

def main():    
    '''
    Trim the provided code down
    '''
    usr_name = input("Please enter your name:\n>").title()
    # usr_name = usr_name.title()    
    usr_date = int(input("Please enter your birth year in YYYY format, e.g 2010:\n>"))
    sign = usr_date % 12 # ex: = 0 => monkey 1 => rooster
    zodiac = [
        "your zodiac sign is Monkey, you are sharp, smart, curious, and mischievous.",
    ...
    #     print(f"{usr_name} your zodiac sign is Ox, you are strong, thorough, determined, loyal, and reliable.")
    # elif usr_date in [2012, 2000, 1988, 1976, 1964]:    
    #     print(f"{usr_name} your zodiac sign is Dragon, you are talented, powerful, lucky, and successful.")
    ...
    #     print(f"{usr_name} your zodiac sign is Monkey, you are sharp, smart, curious, and mischievous.")
