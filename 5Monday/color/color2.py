...
StephanieCobble | Lab 70 - Defining Function
...
def main():
    ...
    # Write a line that prints your name in at least two colors
    print(f'My name is {crayons.magenta("Stephanie")} {crayons.green("Cobble")}')
