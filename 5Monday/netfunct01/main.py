...
StephanieCobble | Lab 69 - Creating functions
'''
...
def commandpush(devicecmd): # devicecmd==dict
    ...
    for ip in devicecmd.keys(): # looping through the dict
        print(f'{crayons.magenta("Handshaking")}. .. ... connecting with {ip}') # fstring
...
def main():
    ...
    print(f"Welcome to the {crayons.cyan('network')} device command pusher") # welcome message
