...
StephanieCobble - Lab 75 - Class Inheritance cont
...
from cheatdice import Weighted

def main():
    '''
    run-time code
    Added cheater3 to replace cheater 2 to test the weighted dice
    '''
    ...
    cheater3 = Weighted() # first roll won't be under 3
